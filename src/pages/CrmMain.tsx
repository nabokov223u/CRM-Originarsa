...
export function CrmMain() {
  ...
  const renderContent = () => {
      ...
      return (
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">Cargando datos desde Firebase...</p>
          </div>
        </div>
      );
    }
    ...
    if (error && (activeTab === 'dashboard' || activeTab === 'leads')) {
      return (
        <div className="bg-red-50 border border-red-100 rounded-xl p-6 max-w-md mx-auto mt-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="text-2xl">⚠️</div>
            <h3 className="text-lg font-semibold text-primary">Error de Conexión</h3>
          </div>
    ...
    return (
      <Routes>
        ...
        <Route path="/clientes" element={<ClientesPage leads={leads} />} />
